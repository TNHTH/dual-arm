...
sudo_password = os.environ.get('DUAL_ARM_SUDO_PASSWORD')
if sudo_password:
    chmod_command = ['sudo', '-S', 'chmod', '777', '/dev/ttyACM0']
    subprocess.run(chmod_command, input=sudo_password + '\n', encoding='utf-8')
...
def generate_launch_description():
    ...
    camera_info_interceptor_node = Node(
