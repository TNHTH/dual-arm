...
public:
    ...
    *@param  [in]  opt  After timeout policy, 0- program stops and task notes timeout, 1- ignores timeout task notes and continues execution, 2- waits
    *@return  Error code
	 */
    ...
    *@return  Error code
	 ...
	 * @param [out] Calculation method 0: origin-x axis-z axis 1: origin-x axis-xy plane
