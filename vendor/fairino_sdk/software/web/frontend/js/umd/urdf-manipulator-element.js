(function (global, factory) {
    ...
    class URDFManipulator extends URDFViewer {
        ...
        get highlightColor() { return this.getAttribute('highlight-color') || '#FE6900'; }
        ...
        constructor(...args) {
            ...
            const toMouseCoord = (e, v) => {
                ...
                v.x = ((e.layerX - el.offsetLeft) / el.offsetWidth) * 2 - 1;
                v.y = -((e.layerY - el.offsetTop) / el.offsetHeight) * 2 + 1;
            };
            ...
            const getCollisions = m => {
                ...
                const meshes = [];
                this.virtualRobot.traverse(c => c.type === 'Mesh' && meshes.push(c));
            ...
            this._mouseMoveFunc = e => {
                ...
                // if disableDragging is true, then clear Highlight.
                ...
                if (dragging !== null) {
                    ...
                    if (delta) {
                        ...
                        this.setVirtualAngle(dragging.name, dragging.angle + delta);
