...
"$PYTHON_BIN" scripts/check_path_hardcodes.py
"$PYTHON_BIN" scripts/check_readme_coverage.py
...
colcon build --base-paths packages --packages-up-to competition_console_api robo_ctrl dualarm_task_manager execution_adapter competition_start_gate
