...
class CompetitionConsoleApiNode(Node):
    ...
    def _create_app(self):
        ...
        async def run_acceptance(wave: str):
            wave_commands = {
                "workspace": ["bash", "-lc", "cd /home/gwh/dashgo_rl_project/workspaces/dual-arm && colcon list --base-paths src"],
                "resume": ["bash", "-lc", "cd /home/gwh/dashgo_rl_project/workspaces/dual-arm && source /opt/ros/humble/setup.bash && source install/setup.bash && /usr/bin/python3 src/tools/tools/scripts/smoke_resume_checkpoint.py"],
                "camera_frames": ["bash", "-lc", "cd /home/gwh/dashgo_rl_project/workspaces/dual-arm && source /opt/ros/humble/setup.bash && source install/setup.bash && /usr/bin/python3 src/tools/tools/scripts/smoke_camera_frames.py"],
                "web_console": ["bash", "-lc", "cd /home/gwh/dashgo_rl_project/workspaces/dual-arm/src/ops/competition_console_web && npm run build >/tmp/competition_console_build.log 2>&1 && echo ok"],
                "planning_scene": ["bash", "-lc", "cd /home/gwh/dashgo_rl_project/workspaces/dual-arm && source /opt/ros/humble/setup.bash && source install/setup.bash && /usr/bin/python3 src/tools/tools/scripts/smoke_planning_scene_sync.py"],
            }
