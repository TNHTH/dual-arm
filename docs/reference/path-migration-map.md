...
| `vendor/fairino_sdk` | `vendor/fairino_sdk` | 兼容中 | `third_party -> vendor` 兼容别名保留 |
...
| `/home/gwh/dual-arm-shared` | 并入 `docs/process/parallel-windows/` 与 `.workspace/runtime/shared/` | clean 基线中未纳入主仓，后续只保留兼容说明 |
| `/home/gwh/dual-arm` | 阶段二兼容入口 | 最终主目录目标为 `/home/gwh/dual-arm` |
