...
本护栏适用于 `workspace/software-engineering-hardening-20260426` 分支的 Wave 0-6 工程化整改。整改范围只包含软件层面的代码、配置、测试、文档和仓库治理，不包含任何实机动作。
...
出现以下任一情况时停止当前 Wave，并记录到 `local execution notes`：
