...
- `runbooks/`：安全边界、parallel worker 超时治理、工程流程规范、代码审查和验收 runbook。
...
sed -n '1,200p' docs/operations/runbooks/parallel worker-timeout-policy.md
sed -n '1,200p' docs/operations/runbooks/wave-2-5-acceptance.md
```

## 上下游依赖

- 上游：`STATE.md`、`local continuation notes`
