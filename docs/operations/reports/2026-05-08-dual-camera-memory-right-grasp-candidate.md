...
- 双相机点云记忆 JSON：`local execution notes`
- 融合点云 PLY：`local execution notes`
- 融合点云 NPZ：`local execution notes`
- 3D 浏览器可视化：`local execution notes`
- 右臂夹取候选：`local execution notes`
...
```bash
xdg-open local execution notes
```
