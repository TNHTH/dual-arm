frapp.factory('liveCode', function () {
    let liveCode = {};
    let myCodeMirror;
    ...
    liveCode.initLiveCode = function () {
        myCodeMirror = CodeMirror(document.getElementById("live-code"), {
            value: '',
            mode: "lua",
            lineNumbers: true,
            readOnly: true,
    ...
    liveCode.refresh = function (script) {
