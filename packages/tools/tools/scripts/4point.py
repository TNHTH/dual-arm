...
from dual_arm_paths import repo_path

DEFAULT_POSE_DIR = repo_path(".artifacts", "calibration", "eye_hand", "left", "poses", start=Path(__file__).resolve())
pose_dir = Path(os.environ.get("DUAL_ARM_EYE_HAND_LEFT_POSES", str(DEFAULT_POSE_DIR)))
