...
class DetectorAdapterNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("source_name", "detector")
        ...
        self._source_name = self.get_parameter("source_name").get_parameter_value().string_value
        ...
        self.get_logger().info(
            f"detector_adapter 已启动，输入: {input_topic}，输出: {output_topic}，"
            f"来源: {self._source_name}，类别映射: {self._class_map}"
        )
